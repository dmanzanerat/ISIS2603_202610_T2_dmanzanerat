...
|-------------------------------------|-----------------------------------------------------------------|-----------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Éxito: Carga a bolsillo exitosa** | Existe una cuenta #123 con saldo 5000 y un bolsillo “Ahorros”   | Cargar 1500 al bolsillo “Ahorros” | 1. Se resta 1500 al saldo de la cuenta<br>2. Se suma 1500 al saldo de bolsillo<br>3. Retorna el monto total del bolsillo                             |
| **Fallo: Saldo insuficiente**       | Existe una cuenta #123 con saldo 5000 y un bolsillo “Ahorros”   | Cargar 6000 al bolsillo “Ahorros" | Lanza excepción: BusinessLogicException (“El monto de la transferencia debe ser menor o igual al saldo de la cuenta”). No se hacen cambios en la BD. |
| **Fallo: Bolsillo inexistente**     | Existe una cuenta #456 con saldo 5000 con un bolsillo "Ahorros" | Cargar 1500 al bolsillo "Viaje”   | Lanza excepción: EntityNotFoundException                                                                                                             |
| **Fallo: Monto menor a cero**       | Existe una cuenta #123 con saldo 5000 y un bolsillo "Ahorros"   | Cargar -500 al bolsillo "Ahorros" | Lanza excepción: BusinessLogicException ("El monto de carga debe ser mayor que cero")                                                             
| **Fallo: Cuenta inexistente**       | No existe una cuenta #123                                       | Cargar 100 al bolsillo "Ahorros"  | Lanza Excepcion: EntityNotFoundException                                                                                                             |                          
  
## Regla 2
| **Escenario**                                                          | **Estado Inicial (BD)**                                                 | **Acción (Input)**                                 | **Resultado Esperado (Output/BD)**                                                                                                                                               |
| ---------------------------------------------------------------------- | ----------------------------------------------------------------------- | -------------------------------------------------- |----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Éxito: Ambas cuentas existen y son distintas                           | Existen la cuenta #123 con saldo 5000 y la cuenta #456 con saldo 1000   | Transferir 1500 de la cuenta #123 a la cuenta #456 | 1. Resta 1500 al saldo de la cuenta #123<br>2. Suma 1500 al saldo de la cuenta #456<br>3. Guardo los cambios en la BD<br>4. Retorna el monto total restante de la cuenta origen  |
